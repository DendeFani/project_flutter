...
import 'package:latihan/mawar.dart';
import 'package:latihan/kamboja.dart';
import 'package:latihan/krissan.dart';
import 'package:latihan/sakura.dart';
import 'package:latihan/bangkai.dart';
import 'package:latihan/dahlia.dart';
import 'package:latihan/sepatu.dart';
import 'package:latihan/daisy.dart';
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Daisy()));
                },
                child: ListTile(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Dahlia()));
                },
                child: ListTile(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Bangkai()));
                },
                child: ListTile(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Krissan()));
                },
                child: ListTile(
